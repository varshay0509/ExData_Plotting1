...
par(mfrow=c(2,2))
with(two_day_data,plot( DT,Global_active_power, type= "l", xlab=" ", ylab="Global Active Power"))
with(two_day_data,plot(DT,Voltage, type= "l", xlab="datetime ", ylab="Voltage"))
...
with(two_day_data,plot(DT,Global_reactive_power, type="l", xlab="datetime ", ylab="Global_reactive_power"))
